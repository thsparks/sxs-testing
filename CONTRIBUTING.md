...
3. If you add a level, add its world-map position to `mapStops` in `game.js` (horizontal and vertical percentages), and make sure the unlock progression still makes sense.
